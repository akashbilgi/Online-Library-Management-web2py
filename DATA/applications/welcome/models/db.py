# -*- coding: utf-8 -*-
db=SQLDB("sqlite://aaakaktest3.db")
#########################################################################
...
db.define_table(
        'Books',
        Field('Book_id','string',requires=[IS_NOT_EMPTY(),IS_NOT_IN_DB(db,'Books.Book_id')]),
        Field('Date_','date',requires=IS_NOT_EMPTY()),
        Field('Author','string',requires=IS_NOT_EMPTY()),
        Field('Title','string',requires=IS_NOT_EMPTY()),
        Field('publisher','string',requires=IS_NOT_EMPTY()),
        Field('Edition','string',requires=IS_NOT_EMPTY()),
        Field('year_','integer',requires=IS_NOT_EMPTY()),
        Field('page_','integer',requires=IS_NOT_EMPTY()),
        Field('cost_','float',requires=IS_NOT_EMPTY()),
        Field('Bill_no','string',requires=IS_NOT_EMPTY()),
        Field('call_no','string',requires=IS_NOT_EMPTY()),
        Field('Supplier','string',requires=IS_NOT_EMPTY()),
        Field('ISBN','string'),
        Field('Subject','string',requires=IS_NOT_EMPTY()))

db.define_table(
        'Book_acc',
        Field('Acc_no','string',requires=IS_NOT_EMPTY()),
...
db.define_table(
    'Subject',
    Field('sub_code','string',requires=[IS_NOT_EMPTY(),IS_NOT_IN_DB(db,'Subject.sub_code')]),
    Field('sub_name','string',requires=IS_NOT_EMPTY()),
    Field('sem','string',requires=IS_NOT_EMPTY()))

db.define_table(
    'Sub_taken',
    Field('u_id','string',requires=IS_NOT_EMPTY()),
    Field('sub_code','string',requires=IS_NOT_EMPTY()))

db.define_table(
    'ISSUE',
    Field('u_id','string',requires=IS_NOT_EMPTY()),
    Field('Acc_no','integer',requires=[IS_NOT_EMPTY()]),
    Field('Return_date','date'),
    Field('Issue_date','date',requires=IS_NOT_EMPTY()),
